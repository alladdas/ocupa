...
class CreditService:
    ...
    async def check_and_deduct(
        self, db: AsyncSession, user_id: str, job_id: int, *, is_pro: bool = False
    ) -> str:
        """Deduct one credit. Returns source: 'pro', 'time_pass', 'daily_free', or 'purchased'.
        Raises UsageLimitExceeded if no credits available.
        """
        # Priority 0: Supabase Pro subscription — unlimited, no deduction
        if is_pro:
            return "pro"
