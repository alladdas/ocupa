...
class User(TimestampMixin, Base):
    ...
    supabase_id: Mapped[str | None] = mapped_column(String, unique=True, nullable=True, index=True)
    ...
    is_pro: Mapped[bool] = mapped_column(Boolean, server_default="false", default=False)
